...
// 运输任务状态
// export const TASK_STATUS_NONE: TASK_STATUS_NONE = 0
// export const TASK_STATUS_PENDING: TASK_STATUS_PENDING = 1
// export const TASK_STATUS_DOING: TASK_STATUS_DOING = 2
