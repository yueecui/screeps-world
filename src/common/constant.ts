...
// 运输优先级
export const TASK_PRIORITY_HIGH: TASK_PRIORITY_HIGH = 0
export const TASK_PRIORITY_MIDDLE: TASK_PRIORITY_MIDDLE = 1
export const TASK_PRIORITY_LOW: TASK_PRIORITY_LOW = 2
