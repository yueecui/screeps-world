...
// 运输任务类型
export const TASK_HARU_SPAWN_ENERGY: TASK_HARU_SPAWN_ENERGY = 10
export const TASK_NORMAL_SPAWN_ENERGY: TASK_NORMAL_SPAWN_ENERGY = 11
export const TASK_CONTROLLER_ENERGY: TASK_CONTROLLER_ENERGY = 20
export const TASK_TOWER_ENERGY: TASK_TOWER_ENERGY = 21
export const TASK_STORE_SOURCE: TASK_STORE_SOURCE = 30
export const TASK_STORE_MINERAL: TASK_STORE_MINERAL = 31
export const TASK_RECYCLE_TOMBSTONE: TASK_RECYCLE_TOMBSTONE = 32
export const TASK_RECYCLE_RUIN: TASK_RECYCLE_RUIN = 33
export const TASK_CENTER_LINK_INPUT: TASK_CENTER_LINK_INPUT = 50    // 输入能量到LINK的任务
export const TASK_CENTER_LINK_OUTPUT: TASK_CENTER_LINK_OUTPUT = 51  // 从LINK输出能量的任务

// 运输优先级
export const TASK_CATEGORY_UNKNOWN: TASK_CATEGORY_UNKNOWN = 0
export const TASK_CATEGORY_SPAWN: TASK_CATEGORY_SPAWN = 1
export const TASK_CATEGORY_GIVE: TASK_CATEGORY_GIVE = 2
export const TASK_CATEGORY_TAKE: TASK_CATEGORY_TAKE = 3
export const TASK_CATEGORY_BOTH: TASK_CATEGORY_BOTH = 4
export const TASK_CATEGORY_CENTER: TASK_CATEGORY_CENTER = 5

export const TASK_CATEGORY_SPAWN_NAME: TASK_CATEGORY_SPAWN_NAME = 'spawn'
export const TASK_CATEGORY_GIVE_NAME: TASK_CATEGORY_GIVE_NAME = 'give'
export const TASK_CATEGORY_TAKE_NAME: TASK_CATEGORY_TAKE_NAME = 'take'
export const TASK_CATEGORY_BOTH_NAME: TASK_CATEGORY_BOTH_NAME = 'both'
export const TASK_CATEGORY_CENTER_NAME: TASK_CATEGORY_CENTER_NAME = 'center'
