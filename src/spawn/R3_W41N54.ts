...
export const ROOM_3_CONFIG: Map<string, RoleConfig> = new Map([
    // ['R3-Guu', { body: BODY_CONFIG['侵略者R5'], amount: 1, memory: {r:'攻击'} }],
    // ROOM搬运者

    // ROOM收集者
    ['R3-GA', { body: BODY_CONFIG['WORKER_R3B'], amount: 1, aheadTime: 80, memory: {r:'采集', mode:0, node:0} }],
    ['R3-TS', { body: BODY_CONFIG['CARRYER_R3'], amount: 1, aheadTime: 80, memory: {r:'运输', mode: 0, stay: [33, 33]} }],


    ['R3-GB', { body: BODY_CONFIG['WORKER_R3B'], amount: 1, aheadTime: 80, memory: {r:'采集', mode:0, node:1} }],

    ['R3-TU', { body: BODY_CONFIG['CARRYER_R3'], amount: 1, aheadTime: 80, memory: {r:'运输', mode: 1, stay: [30, 28]} }],
    ...
    // ROOM的建造者
    // ['R3-BB', { body: [WORK, WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE], amount: 1, memory: {r:'建造', mode:0, stay: [35, 32]} }],    // 建造优先
    ['R3-BR', { body: getMaxBuilder3Body(), amount: 1, memory: {r:'建造', mode:1, stay: [35, 32]} }],    // 建造优先
    // ['R2-BD-R', { body: getMaxBuilder2Body(), amount: 1, memory: {r:'建造', mode:1, stay: [20, 26]} }],    // 修理优先
    // ROOM升级者
    ['R3-UP', { body: BODY_CONFIG['WORKER_R3'], amount: 2, memory: {r:'升级'} }],
