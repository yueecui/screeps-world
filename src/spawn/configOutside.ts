...
import { SPAWN_TYPE_OUTSIDE, MODE_BUILDER, MODE_CONTROLLER, MODE_HARVEST_ENERGY, MODE_HARVEST_MINERAL, MODE_HELP, MODE_REPAIRER, MODE_SPAWN, BOOLEAN_TRUE, BOOLEAN_FALSE, MODE_OUTSIDE } from "@/global/constant";
