...
export const ROOM_2_CONFIG: Map<string, RoleConfig> = new Map([
    ...
    ['R2-TR-U', { body: BODY_CONFIG['运输者R2'], amount: 1, aheadTime: 80, memory: {r:'运输', mode: 1, stay: [26, 26]} }],
    // ROOM收集者
    ...
    // ROOM的建造者
    ['R2-BD-B', { body: BODY_CONFIG['BUILDER_R2'], amount: 1, memory: {r:'建造', mode:0, stay: [29, 27]} }],    // 建造优先
    ['R2-BD-R', { body: BODY_CONFIG['BUILDER_R2'], amount: 1, memory: {r:'建造', mode:1, stay: [20, 26]} }],    // 修理优先
    // ROOM升级者
    ['R2-UP', { body: BODY_CONFIG['WORKER_R2'], amount: 2, memory: {r:'升级'} }],
