...
export const TASK_SPAWN_ENERGY: TASK_SPAWN_ENERGY = 1
export const TASK_CONTROLLER_ENERGY: TASK_CONTROLLER_ENERGY = 2
export const TASK_TOWER_ENERGY: TASK_TOWER_ENERGY = 3
export const TASK_STORE_ENERGY: TASK_STORE_ENERGY = 4
export const TASK_RECYCLE_TOMBSTONE: TASK_RECYCLE_TOMBSTONE = 5
export const TASK_RECYCLE_RUIN: TASK_RECYCLE_RUIN = 6
export const TASK_STORE_MINERAL: TASK_STORE_MINERAL = 7
